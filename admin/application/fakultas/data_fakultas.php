...
switch ($action) {
    case 'add'  : $fakultasClass->insertData($params);
        break;
...
class Fakultas {
    ...
    function insertData($params) {
        $data = [];
        $sql = "INSERT INTO master_fakultas";
        $sql .= " (kode_fakultas, nama_fakultas) ";
        $sql .= " VALUES ('".$params['kode']."', '".$params['fakultas']."') ";
    ...
    function updateData($params) {
        $data = [];
        $sql = "UPDATE master_fakultas";
        $sql .= " SET kode_fakultas = '".$params['kode']."', nama_fakultas = '".$params['fakultas']."'";
